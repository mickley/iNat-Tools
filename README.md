...
The [Species Count](speciescount/) tool returns a list of taxa and the number of observations for each taxon, for a given set of filters. It can be used to find species with few observations that might be incorrectly identified, cultivated, rare, interesting, or in need of more observations to be included in the vision model.
